...
email_school: yuxiang.phd@gmail.com
email_personal: yuxiang.phd@gmail.com
github_id: UniverseFly
github_url: https://github.com/UniverseFly
linkedin_url: https://linkedin.com/in/yuxiang-wei-a94a63205
...
I am a final-year PhD candidate at [UIUC CS](https://siebelschool.illinois.edu/), advised by [Lingming Zhang](https://lingming.cs.illinois.edu). I was also a student researcher at [Meta FAIR](https://ai.meta.com/) from 2024--2025, working at the CodeGen/CodeLlama team.

<!-- [Sida Wang](https://www.sidaw.xyz), [Rishabh Singh](https://rishabhmit.bitbucket.io), [Daniel Fried](https://dpfried.github.io), and [Gabriel Synnaeve](https://scholar.google.com/citations?user=wN9rBkcAAAAJ&hl=en). I train LLMs for code and software.-->

I train code agents.

**Research impact:** I lead [Self-Play SWE-RL (SSR)](https://x.com/YuxiangWei9/status/2003541373853524347?s=20) (ICML'26), [SWE-RL](https://github.com/facebookresearch/swe-rl) (NeurIPS'25), [Magicoder](https://github.com/ise-uiuc/magicoder) (ICML'24), and [SelfCodeAlign](https://github.com/bigcode-project/selfcodealign) (NeurIPS'24), projects that have captured broad attention and are widely adopted across industry and open source.

<!-- **New:** We released [Self-Play SWE-RL (SSR)](https://x.com/YuxiangWei9/status/2003541373853524347?s=20), which trains a single LLM agent to self-improve by self-playing between bug-injection and bug-repair, grounded in real-world repositories, no human-labeled issues or tests. -->

<!-- , with experience and published results in pretraining, midtraining, and posttraining via synthetic data and reinforcement learning. -->
...
- Dec 2025, DL4C@NeurIPS'25 Best Paper Award
- July 2025, 🥇[1st Place, Amazon Nova AI Challenge ($250K)](https://www.amazon.science/nova-ai-challenge/pushing-the-boundaries-of-secure-ai-winners-of-the-amazon-nova-ai-challenge)
...
- Oct 2025, [North Carolina State University @ GAI4SE](https://github.com/gai4se/GAI4SE-Course): Large Language Models for Autonomous Software Engineering
